...
public class Session extends Thread {
    ...
    public void upload()
    {
        try
        {
            ...
            if(filesize>ServerMain.MAX_BUFFER_SIZE)
            {
            ...
            {
                while(filesize + ServerMain.CUR_BUF > ServerMain.MAX_BUFFER_SIZE) ;
            ...
            ServerMain.fileIDtoName.put(fileID,filename);
            ...
            for (int i = 1; i <= numberOfChunks; i++) {
                ...
                System.out.println("Uploaded "+filename+" "+String.format("%.2f",off*100.0/array.length)+"%");
            }
            ...
            if (!broken&&fin.equalsIgnoreCase("Completed")) {
                ...
                File file = new File("src/Server/" + studentID + "/" + mode + "/" + filename);
            ...
            ServerMain.CUR_BUF-=filesize;
            System.out.println("CUR BUF: "+ServerMain.CUR_BUF);
        }
        catch (Exception e)
        {
            e.printStackTrace();
